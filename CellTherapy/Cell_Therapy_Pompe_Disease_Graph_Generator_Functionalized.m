function Endpoint = Cell_Therapy_Pompe_Disease_Graph_Generator_Functionalized(Progenitor_Dose, GAA_Boost, Half_Life)
...
%% Alter DoubleAlleleGAABoost
 % Set to 0, 0.25, 0.5, 0.75, 1, 1.25 and 1.5 to figure out the boost
...
d_mat.TargetName = 'M_Double_Precise'; 
d_mat.Amount = 10e9;
