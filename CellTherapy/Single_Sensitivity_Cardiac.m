...
C_Muscle_Total = CCModeldata.Data(N_datapoints,33)+CCModeldata.Data(N_datapoints,34);
C_Muscle_Healthy = CCModeldata.Data(N_datapoints,34);
BasalHealthyPercent = C_Muscle_Healthy/C_Muscle_Total * 100;
...
for i = CyclingParamIndices
    ...
    C_Muscle_Total = CCModeldata.Data(N_datapoints,33)+CCModeldata.Data(N_datapoints,34);
    C_Muscle_Healthy = CCModeldata.Data(N_datapoints,34);
    PosHealthyPercentSens(j) = C_Muscle_Healthy/C_Muscle_Total * 100;
